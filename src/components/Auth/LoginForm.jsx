    ...
    >
      ...
      <FaLock style={{color:"grey",position:"absolute",top:"calc(42%)",left:"1.65%",fontSize:"20px"}}/>
        ...
        <input
          ...
          className="w-full rounded-[0.5rem] bg-blue-50 p-[12px] pr-12 text-richblack-5"
        />
        <span
        ...
        <Link to="/forgot-password" className="text-end" >
          <p className="text-end mt-1 text-xs text-blue-100">
            Forgot Password
          </p>
        </Link>
      </label>
      <button
        type="submit"
        className="mt-6 rounded-[8px] bg-green-200 py-[8px] px-[12px] font-medium text-richblack-900
        hover:bg-green-300 transition-all duration-200 ease-linear"
      >
        Sign In
      </button>
